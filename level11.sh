...
#createdDict=$(head -n $pseudoRAND12 masterArray.txt | tail -1)
...
echo "* Create 3 new directories in the level11 directory named after the lines of the file." >> level11/README
echo "* Once finished, run the verify.sh script." >> level11/README

## potential for reuse of level scripts with different set of directions