...
pseudoRAND3=$(( $pseudoRAND3 + 2 ))
pseudoRAND4=$(( $pseudoRAND4 + 3 ))
pseudoRAND5=$(( $pseudoRAND5 + 4 ))
pseudoRAND6=$(( $pseudoRAND6 + 5 ))
pseudoRAND7=$(( $pseudoRAND7 + 6 ))
pseudoRAND8=$(( $pseudoRAND8 + 7 ))
pseudoRAND9=$(( $pseudoRAND9 + 8 ))
