...
readarray -t dict10 <dictionaries/appliances.txt
readarray -t dict1 <dictionaries/colleges.txt
readarray -t dict13 <dictionaries/candy.txt
...
readarray -t dict11 <dictionaries/instruments.txt
readarray -t dict8 <dictionaries/countries.txt
readarray -t dict14 <dictionaries/dogBreeds.txt
readarray -t dict7 <dictionaries/fruits.txt
readarray -t dict6 <dictionaries/operatingSystems.txt
readarray -t dict4 <dictionaries/seasonings.txt
readarray -t dict2 <dictionaries/sports.txt
readarray -t dict12 <dictionaries/fastFood.txt
...
secondCapture=$(cut -c 2 userHash.txt)
...
## noise files
mkdir level10/"$secondTargetDirectory"/"${dictNumber1[2]}"
mkdir level10/"$secondTargetDirectory"/"${dictNumber1[6]}"
mkdir level10/"$secondTargetDirectory"/"${dictNumber1[15]}"
mkdir level10/"$secondTargetDirectory"/"${dictNumber1[14]}"
mkdir level10/"$secondTargetDirectory"/"${dictNumber1[13]}"
mkdir level10/"$secondTargetDirectory"/"${dict12[4]}"

mkdir level10/"$noiseDirectory1"/"${dictNumber1[2]}"
mkdir level10/"$noiseDirectory1"/"${dictNumber1[6]}"
mkdir level10/"$noiseDirectory1"/"${dictNumber1[15]}"
mkdir level10/"$noiseDirectory1"/"${dictNumber1[14]}"
mkdir level10/"$noiseDirectory1"/"${dictNumber1[13]}"
mkdir level10/"$noiseDirectory1"/"${dict12[4]}"
#############
mkdir level10/"$noiseDirectory2"/"${dictNumber1[2]}"
mkdir level10/"$noiseDirectory2"/"${dictNumber1[6]}"
mkdir level10/"$noiseDirectory2"/"${dictNumber1[15]}"
mkdir level10/"$noiseDirectory2"/"${dictNumber1[14]}"
mkdir level10/"$noiseDirectory2"/"${dictNumber1[13]}"
mkdir level10/"$noiseDirectory2"/"${dict12[4]}"

mkdir level10/"$noiseDirectory3"/"${dictNumber1[2]}"
mkdir level10/"$noiseDirectory3"/"${dictNumber1[6]}"
mkdir level10/"$noiseDirectory3"/"${dictNumber1[15]}"
mkdir level10/"$noiseDirectory3"/"${dictNumber1[14]}"
mkdir level10/"$noiseDirectory3"/"${dictNumber1[13]}"
mkdir level10/"$noiseDirectory3"/"${dict12[4]}"

mkdir level10/"$noiseDirectory4"/"${dictNumber1[2]}"
mkdir level10/"$noiseDirectory4"/"${dictNumber1[6]}"
mkdir level10/"$noiseDirectory4"/"${dictNumber1[15]}"
mkdir level10/"$noiseDirectory4"/"${dictNumber1[14]}"
mkdir level10/"$noiseDirectory4"/"${dictNumber1[13]}"
mkdir level10/"$noiseDirectory4"/"${dict12[4]}"



cp level10Verify.sh level10/
...
touch level10/"$secondTargetDirectory"/"$firstDataFile"
touch level10/"$secondTargetDirectory"/"$secondDataFile"
touch level10/"$secondTargetDirectory"/"$thirdDataFile"
touch level10/"$secondTargetDirectory"/"$fourthDataFile"
touch level10/"$secondTargetDirectory"/"$fifthDataFile"
touch level10/"$secondTargetDirectory"/"$sixthDataFile"

touch level10/"$noiseDirectory1"/"$firstDataFile"
touch level10/"$noiseDirectory1"/"$secondDataFile"
touch level10/"$noiseDirectory1"/"$thirdDataFile"
touch level10/"$noiseDirectory1"/"$fourthDataFile"
touch level10/"$noiseDirectory1"/"$fifthDataFile"
touch level10/"$noiseDirectory1"/"$sixthDataFile"

touch level10/"$noiseDirectory2"/"$firstDataFile"
touch level10/"$noiseDirectory2"/"$secondDataFile"
touch level10/"$noiseDirectory2"/"$thirdDataFile"
touch level10/"$noiseDirectory2"/"$fourthDataFile"
touch level10/"$noiseDirectory2"/"$fifthDataFile"
touch level10/"$noiseDirectory2"/"$sixthDataFile"

touch level10/"$noiseDirectory3"/"$firstDataFile"
touch level10/"$noiseDirectory3"/"$secondDataFile"
touch level10/"$noiseDirectory3"/"$thirdDataFile"
touch level10/"$noiseDirectory3"/"$fourthDataFile"
touch level10/"$noiseDirectory3"/"$fifthDataFile"
touch level10/"$noiseDirectory3"/"$sixthDataFile"

touch level10/"$noiseDirectory4"/"$firstDataFile"
touch level10/"$noiseDirectory4"/"$secondDataFile"
touch level10/"$noiseDirectory4"/"$thirdDataFile"
touch level10/"$noiseDirectory4"/"$fourthDataFile"
touch level10/"$noiseDirectory4"/"$fifthDataFile"
touch level10/"$noiseDirectory4"/"$sixthDataFile"


echo "* Level 7" >> level10/README
echo " Remove all the .csv files inside the $secondTargetDirectory directory" >> level10/README
echo " Remove the $thirdTargetDirectory directory" >> level10/README
