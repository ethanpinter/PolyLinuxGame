...
mkdir level10/"$secondTargetDirectory"/"${dictNumber1[4]}"
mkdir level10/"$secondTargetDirectory"/"${dictNumber1[6]}"
mkdir level10/"$secondTargetDirectory"/"${dictNumber1[8]}"
mkdir level10/"$secondTargetDirectory"/"${dictNumber1[10]}"
mkdir level10/"$secondTargetDirectory"/"${dict14[2]}"

mkdir level10/"$noiseDirectory1"/"${dictNumber1[2]}"
mkdir level10/"$noiseDirectory1"/"${dictNumber1[4]}"
mkdir level10/"$noiseDirectory1"/"${dictNumber1[6]}"
mkdir level10/"$noiseDirectory1"/"${dictNumber1[8]}"
mkdir level10/"$noiseDirectory1"/"${dictNumber1[10]}"
mkdir level10/"$noiseDirectory1"/"${dict14[2]}"
#############
mkdir level10/"$noiseDirectory2"/"${dictNumber1[2]}"
mkdir level10/"$noiseDirectory2"/"${dictNumber1[4]}"
mkdir level10/"$noiseDirectory2"/"${dictNumber1[6]}"
mkdir level10/"$noiseDirectory2"/"${dictNumber1[8]}"
mkdir level10/"$noiseDirectory2"/"${dictNumber1[10]}"
mkdir level10/"$noiseDirectory2"/"${dict14[2]}"

mkdir level10/"$noiseDirectory3"/"${dictNumber1[2]}"
mkdir level10/"$noiseDirectory3"/"${dictNumber1[4]}"
mkdir level10/"$noiseDirectory3"/"${dictNumber1[6]}"
mkdir level10/"$noiseDirectory3"/"${dictNumber1[8]}"
mkdir level10/"$noiseDirectory3"/"${dictNumber1[10]}"
mkdir level10/"$noiseDirectory3"/"${dict14[2]}"

mkdir level10/"$noiseDirectory4"/"${dictNumber1[2]}"
mkdir level10/"$noiseDirectory4"/"${dictNumber1[4]}"
mkdir level10/"$noiseDirectory4"/"${dictNumber1[6]}"
mkdir level10/"$noiseDirectory4"/"${dictNumber1[8]}"
mkdir level10/"$noiseDirectory4"/"${dictNumber1[10]}"
mkdir level10/"$noiseDirectory4"/"${dict14[2]}"
